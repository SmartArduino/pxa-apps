...
STRINGS = [
    ...
    ('MOB_SWARM', 'swarm of flies', '蝇群'),
    ('MOB_DM100', 'DM-100', 'DM-100机械守卫'),
    # --- chrome ---------------------------------------------------------
    ...
    # --- amulet and victory --------------------------------------------
    ('CLIMB_UP', 'You climb up to depth %d.', '你上到了第 %d 层。'),
    ('AMULET_DROPS', 'The Amulet of Yendor lies on the ground!', 'Yendor护符掉落在地上！'),
    ('AMULET_FOUND', 'You found the Amulet of Yendor!', '你拿到了Yendor护符！'),
    ('AMULET_ASCEND', 'You escaped with the Amulet of Yendor!', '你带着Yendor护符逃出了地牢！'),
    ('AMULET_KEEP', 'The Amulet cannot be discarded.', 'Yendor护符无法丢弃。'),
    ('ITEM_AMULET', 'Amulet of Yendor', 'Yendor护符'),
    ('DETAIL_AMULET', 'choose your ending', '选择冒险的结局'),
    ('AMULET_LINE_1', 'The Amulet is yours.', '你拿到了Yendor护符'),
    ('AMULET_LINE_2', 'End your journey?', '现在结束冒险吗？'),
    ('AMULET_EXIT', 'END ADVENTURE', '结束冒险'),
    ('AMULET_STAY', 'KEEP EXPLORING', '继续探索'),
    ('STAT_LEVEL', 'Level %d', '等级 %d'),
    ('STAT_KILLS', 'Kills %d', '击杀 %d'),
    ('STAT_GOLD', 'Gold %d', '金币 %d'),
    ('STAT_TURNS', 'Turns %d', '回合 %d'),
    # --- search, buffs and magic ----------------------------------------
    ('POISONED', 'You are poisoned!', '你中毒了！'),
    ('POISON_DAMAGE', 'Poison costs you 1 HP.', '毒素使你失去 1 点生命。'),
    ('POISON_FADE', 'The poison fades.', '毒性消退了。'),
    ('POISON_CURED', 'The healing potion cures poison.', '治疗药水解除了中毒。'),
    ('POISON_DEATH', 'You die from poison...', '你因中毒而死……'),
    ('ITEM_WAND_MAGIC', 'Wand of Magic Missile', '魔弹法杖'),
    ('DETAIL_WAND_MAGIC', '%d/%d charges', '%d/%d 充能'),
    ('WAND_AIM', 'Tap a visible enemy to zap.', '点击可见的敌人施放魔弹。'),
    ('WAND_EMPTY', 'The wand is out of charges.', '法杖的充能耗尽了。'),
    ('WAND_TARGET', 'No visible enemy there.', '那里没有可见的敌人。'),
    ('TRAP_DART_HIT', 'Poison darts strike! %d damage.', '毒镖射来！受到 %d 点伤害。'),
    ('TRAP_BLAST_HIT', 'An explosion! %d damage.', '陷阱爆炸！受到 %d 点伤害。'),
    ('SWARM_SPLITS', 'The swarm splits apart!', '蝇群分裂了！'),
]
